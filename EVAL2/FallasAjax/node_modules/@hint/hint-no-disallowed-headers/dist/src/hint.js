    ...
    constructor(context) {
        ...
        const validate = ({ response, resource }) => {
            ...
            if (!disallowedHeaders.includes('server') &&
                ...
                const message = i18n_import_1.getMessage('headerValueShouldOnlyContain', context.language, response.headers.server);
            ...
            if (numberOfHeaders > 0) {
                ...
                if (numberOfHeaders === 1) {
                    message = i18n_import_1.getMessage('disallowedHeader', context.language, utils_string_1.prettyPrintArray(headers));
                }
                else {
                    message = i18n_import_1.getMessage('disallowedHeaders', context.language, utils_string_1.prettyPrintArray(headers));
                }
