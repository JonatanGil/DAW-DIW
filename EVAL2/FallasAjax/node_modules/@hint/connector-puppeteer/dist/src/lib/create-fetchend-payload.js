...
exports.createFetchEndPayload = async (response, fetchContent, dom) => {
    ...
    const responseHeaders = utils_connector_tools_1.normalizeHeaders(response.headers());
    const { charset, mediaType } = utils_1.getContentTypeData(element, originalUrl, responseHeaders, body.rawContent);
