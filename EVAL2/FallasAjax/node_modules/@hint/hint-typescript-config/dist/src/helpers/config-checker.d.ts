...
declare const configChecker: (property: string, desiredValue: boolean, messageName: MessageName, context: HintContext<import("hint").Events>, severity: Severity) => (evt: TypeScriptConfigParse) => void;
