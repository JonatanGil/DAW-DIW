...
class HttpCompressionHint {
    constructor(context) {
        ...
        const checkBrotli = async (resource, element) => {
            ...
            if (!compressedWithBrotli) {
                context.report(resource, i18n_import_1.getMessage('compressedWithBrotliOverHTTPS', context.language), { element, severity: utils_types_1.Severity.warning });
                return;
            }
        ...
        const checkGzipZopfli = async (resource, element, shouldCheckIfCompressedWith) => {
            ...
            if (!compressedWithGzip && shouldCheckIfCompressedWith.gzip) {
                context.report(resource, generateGzipCompressionMessage('gzip'), { element, severity: utils_types_1.Severity.error });
                return;
            }
