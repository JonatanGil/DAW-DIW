    ...
    async fetch(url) {
        ...
        const promise = new Promise(async (resolve, reject) => {
            ...
            try {
                ...
                const { charset, mediaType } = utils_1.getContentTypeData(element, fetchEndEvent.resource, fetchEndEvent.response.headers, fetchEndEvent.response.body.rawContent);
